...
<Library LVVersion="17008000">
	...
	<Item Name="Buffer state.ctl" Type="VI" URL="../Buffer state.ctl"/>
	<Item Name="Buffer Settings.ctl" Type="VI" URL="../Buffer Settings.ctl"/>
	<Item Name="Buffer DATA cluster.ctl" Type="VI" URL="../Buffer DATA cluster.ctl"/>
	<Item Name="Buffer DATA OUT ordered.ctl" Type="VI" URL="../Buffer DATA OUT ordered.ctl"/>
	<Item Name="Buffer.vi" Type="VI" URL="../Buffer.vi"/>
	<Item Name="Buffer CORE.vi" Type="VI" URL="../Buffer CORE.vi"/>
</Library>
